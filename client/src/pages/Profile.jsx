            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-1">{profile.name}</h2>
                    ...
                    <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                        <Link
                            to="/activity"
                            className="flex-1 sm:flex-none px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors text-center"
                        >
                            Activity
                        </Link>
                        {userMode === 'worker' && (
                        ...
                        <>
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-xl p-5 border border-purple-200">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-xs font-semibold text-purple-700 uppercase tracking-wide">Average Rating</p>
                                </div>
                                <div className="flex items-baseline gap-2">
                                    <span className="text-3xl font-bold text-gray-900">{stats.rating > 0 ? stats.rating.toFixed(1) : '—'}</span>
                                    {stats.rating > 0 && (
