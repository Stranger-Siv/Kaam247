    ...
    <div className="w-full overflow-x-hidden">
      ...
      >
        <button
          ...
          className={`flex items-center justify-between md:justify-start gap-2 px-3 py-2 rounded-lg text-sm font-medium border transition-colors w-full md:w-auto ${statusFilter || categoryFilter || cityFilter
