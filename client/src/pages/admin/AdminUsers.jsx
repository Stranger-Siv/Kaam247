...
function AdminUsers() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-2 break-words">Users</h1>
        <p className="text-gray-600 break-words">Manage and monitor all users</p>
      </div>
            ...
            {users.map((user) => (
              ...
              >
                <div className="flex items-start justify-between mb-3 gap-2 w-full min-w-0">
                  ...
                  <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border flex-shrink-0 ${getStatusBadge(user.status)}`}>
                    {user.status || 'active'}
                  </span>
                </div>
