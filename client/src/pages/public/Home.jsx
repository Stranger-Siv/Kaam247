...
function Home() {
    ...
    return (
        <div className="bg-white">
            {/* HERO SECTION */}
            <section className="bg-white py-12 sm:py-16 lg:py-20 px-3 sm:px-6 lg:px-8">
            ...
            {/* CATEGORIES */}
            <section className="bg-gray-50 py-12 sm:py-16 px-3 sm:px-6 lg:px-8">
            ...
            {/* HOW IT WORKS */}
            <section className="bg-white py-12 sm:py-16 px-3 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto">
