...
function NotificationToast() {
  ...
  return (
    <>
      ...
      <div
        className="hidden sm:block fixed top-20 right-6 left-6 sm:left-auto sm:max-w-md z-[1500] animate-slide-in"
        onClick={handleViewTask}
      >
        <div className="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden cursor-pointer hover:shadow-3xl transition-shadow">
          {/* Header */}
