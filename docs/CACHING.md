...
- **Admin dashboards (stats, dashboard, charts, pilot-dashboard):** on task state change (create, accept, start, complete, cancel, bulk cancel, admin cancel/unassign/hide) or user state change (block, unblock, ban).
